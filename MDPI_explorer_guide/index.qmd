...
`journal_papers()`: This function looks into the target journal sitemap and returns a vector containing all journal papers URLs. To use it, it requires a string with the code name of the target journal:
